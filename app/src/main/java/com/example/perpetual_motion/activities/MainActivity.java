...
import static com.example.perpetual_motion.classes.Utils.showInfoDialog;
import static com.example.perpetual_motion.classes.Utils.showYesNoDialog;
...
import com.example.perpetual_motion.classes.Utils;
import com.example.perpetual_motion.interfaces.AdapterOnItemClickListener;
import com.google.android.material.snackbar.Snackbar;
import com.example.perpetual_motion.databinding.ActivityMain2Binding;
import com.example.perpetual_motion.databinding.MainIncludeActivityBottomBarAndFab2Binding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private MainIncludeActivityBottomBarAndFab2Binding bottomBarAndFabBinding;
    ...
    private void setupButtonListeners() {
        binding.contentMain.bb.buttonDeal.setOnClickListener(view -> turn_action_deal());
        binding.contentMain.bb.buttonDiscard.setOnClickListener(view -> turn_action_discard());
        binding.contentMain.bb.buttonUndo2.setOnClickListener(view -> turn_action_undo());
    }

    private void setContentView() {
        binding = ActivityMain2Binding.inflate(getLayoutInflater());
        bottomBarAndFabBinding = MainIncludeActivityBottomBarAndFab2Binding.bind(binding.getRoot());

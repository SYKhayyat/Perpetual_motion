...
public class MainActivity extends AppCompatActivity {
    ...
    // Preference Keys: values are already in strings.xml and will beassigned to these in onCreate
    ...
    private void showSB_AlreadyGameOver() {
        if (mPrefShowErrors) {
            ...
            mSnackbar.setAction(R.string.new_game, new
...
// If the file on the device does not yet exist, then it will be created
        SharedPreferences preferences =
                getSharedPreferences(mKeyPrefsName, MODE_PRIVATE);
